...
func (e *RouteApi) FindRouteById(ctx context.Context, req *route_api.Request, rsp *route_api.Response) error {
	common.Info("Received routeApi.FindRouteById request")
...
func (e *RouteApi) AddRoute(ctx context.Context, req *route_api.Request, rsp *route_api.Response) error {
...
func (e *RouteApi) DeleteRouteById(ctx context.Context, req *route_api.Request, rsp *route_api.Response) error {
...
func (e *RouteApi) UpdateRoute(ctx context.Context, req *route_api.Request, rsp *route_api.Response) error {
...
func (e *RouteApi) Call(ctx context.Context, req *route_api.Request, rsp *route_api.Response) error {
